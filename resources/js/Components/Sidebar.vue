<template>
    <div>
                                        ...
                                        <!-- <li>
                                            ...
                                            <ul role="list" class="-mx-2 mt-2 space-y-1">
                                                <li v-for="team in teams" :key="team.name">
                                                    <a :href="team.href"
                                                        :class="[team.current ? 'bg-indigo-700 text-white' : 'text-indigo-200 hover:bg-indigo-700 hover:text-white', 'group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold']">
                                                        <span
        ...
        <!-- Final menu lateral Mobile -->

        <!-- Inicio menu lateral Desktop -->
...
import { menuItems } from "../Components/data/DataMenu"
